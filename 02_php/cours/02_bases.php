  ...
  <main class="container-fluid px-5">
    <div class="row border p-5 mt-5">
        <div class="col-sm-12 col-md-6">
            ...
            <p>Pour ouvrir un passage en PHP , on utilise la balise <span class="fw-bold">?php</span></p>
            <p>Pour ouvrir un passage en PHP , on utilise la balise <span class="fw-bold">?></span></p>
        </div>
    </div>
    <div  class="col -sm-12 col-md-6">
    ...
    <div class="col-sm-12">
        ...
        <ul>
            ...
            <div class="alert alert-primary w-50">
                <?php
                echo "je suis un texte en php  dans une instruction <span>print</span>"
                ?>

            </div>
            <li>
                L'instruction <span>print</span> : c'est un einstruction d'affichage. Nous pouvons y mettre du HTML
            </li>
            <div class="alert alert-primary w-50">
                <?php
            ...
            <li>Les instruction8 <span>var_dump()</span>et <span>print_r</span> : permettent d'afficher du contenu mais on s'en servira principalment pour débugger. Ces deux fonctions permettent d'analyser dans le navigateur le contenu d'une varaible par exemple ( nous en verrons l'utilisation plus tard )</li>
        </ul>
    </div>
    <div class="col-sm-12">
        <h2>5- Concaténation</h2>
        <p>Une variable est un espace mémoire qui porte un nom et qui <span>.</span>(point)</p>
    </div>
    <div>
    <div class="col-sm-12">
        <h2>6- Les variables utilisateur</h2>
        <p>Une variabme est un espace mémoire qui porte un nom et qui permet de conserver une valeur. Cette valeur peut être de n'importe quel type.</p>
                ...
                <div class="col-sm-12 col-md-4 me-5 alert alert-danger">
                        ...
                        <div class="col-sm-12">
                        <h2>7- Affection des variables utilisateurs</h2>
                        <p>Affecter une varible consiste à lui donner une valeur : lorsque vous déclarer une variable vous ne lui donnez pas de type c'est la valeur que vous lui affectez qui a déterminer son type</p>
                        <ul>
                            <li><span>$maVar1 = 75; => integer</span></li>
                            <li><span>$maVar2  = "Paris"; => string</span></li>
                            <li><span>$maVar3 = 12.5; => double</span></li>
                            <li><span>$maVar4 = 12.5; => boolean</span></li>
                        </ul>
                     </div>
                     <div class="col-sm-12">
