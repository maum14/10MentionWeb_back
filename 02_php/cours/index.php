...
<nav class="navbar navbar-dark bg-dark navbar-expand-lg" >
  ...
  <header class=" p-5 m-4 bg-light rounded-3 border">
    <section class="container py-5">
        ...
        <p class="col-md-12 fs-4"> PhP , ce sigle est un acronyme récursif <span>Préprocesseur Hypertexte PHP</span>(PHP hypertext Preprocessor). Il s'agit d'un langage de script côté serveur open source utilisé pour le développement web dynamique et peut etre intégré dans des codes HTML, notez bien qu'un navigateur ne comprend pas le PHP </p>
    </section>
